        ...
        <div className="flex flex-col items-center gap-2 lg:gap-6 p-0 md:p-8">
          ...
          <div className="space-y-2 md:space-y-2 flex flex-col gap-2 lg:gap-6 p-8">
            ...
            <p className="text-md lg:text-lg text-secondary max-w-[800px]">
              ...
              provided.
              <br />
              If you encountered an error with our service that prevented you
              from using your credits to generate images, please contact our
              support team. We will investigate the issue and, if confirmed, we
              will provide a refund for the affected credits.
            </p>
          </div>
