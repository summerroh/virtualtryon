      ...
      <div className="mt-10 lg:mt-10" data-aos="fade-up">
        <div className="flex flex-wrap justify-center -mx-5">
          {monthlyPricingPlans.map((plan) => (
            <div key={plan.id} className="w-full sm:w-1/2 lg:w-1/3 px-5">
              <div className={`pr-column mt-10`}>
                <div className="pr-header pb-8 mb-11">
                  <div className="price font-medium text-dark">
                    {plan.price}
                  </div>
                ...
                <div className="pt-14 lg:pt-8">
                  <div className="trial-text opacity-75 mb-5">
                    Up to 7 user + 1.99 per user
                  </div>
                  <Button className="font-medium transition duration-300 w-full text-center block">
                    Sign up
                  </Button>
                </div>
              </div>
